define(
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'Amasty_CheckoutCore/onepage/place-order',
            ...
            placeOrder: function () {
                ...
                var errorMessage = '';
                console.log('selected value ='+jQuery('div[name="amcheckoutDelivery.time"] :selected').val());
                if (jQuery('input[name="date"]').val()==undefined || jQuery('input[name="date"]').val()==''
                    || jQuery('select[name="time"]').val()==undefined || jQuery('select[name="time"]').val()=='' || jQuery('select[name="time"]').val()<='0' ||jQuery('div[name="amcheckoutDelivery.time"] :selected').val() == -1){
                    errorMessage = $.mage.__('Delivery Date and Time is required');
                ...
                if ((!quote.shippingMethod() && !quote.isVirtual()) || jQuery('.shipping-no-block:visible').length==1) {
